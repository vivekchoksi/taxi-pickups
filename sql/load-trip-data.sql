...
-- --------------------------
-- SQL queries to load trip data into a MySQL table.
-- These queries only load the trip data from one file,
-- trip_data_1.csv.
...
LOAD DATA LOCAL INFILE '/Users/vivek/Documents/Git/taxi-pickups/sql/trip_data_1.csv' 
